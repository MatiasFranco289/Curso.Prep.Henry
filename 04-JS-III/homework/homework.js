...
function dePalabrasAFrase(palabras) {
  ...
  for(var f=0;f<palabras.length;f++){
    respuesta+=palabras[f]+" ";
  }

  return respuesta.slice(0,-1);
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  for(var f=0;f<resultadosTest.length;f++){
    totalPuntajes+=resultadosTest[f];
  }

  return totalPuntajes/resultadosTest.length;
}
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  let strFirstDigit=String(n);

  return strFirstDigit[0]=='9';
}
